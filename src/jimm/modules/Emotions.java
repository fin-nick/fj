...
//    private ListItem[] smileListItems;
    ...
    public void load() {
        ...
        try {
            ...
            dos.read(str);
            String content = StringConvertor.byteArrayToString(str);
...
//        smileListItems = new ListItem[size];
        StringBuffer smileChars = new StringBuffer(textCorr.size());
        for (int i = 0; i < size; i++) {
            Object[] data = (Object[])textCorr.elementAt(i);
            textCorrWords[i]   = (String)data[0];
            textCorrIndexes[i] = ((Integer)data[1]).intValue();
            
            smileChars.append(textCorrWords[i].charAt(0));
        }
        this.smileChars = smileChars.toString();
    ...
    public ListItem getSmileItem(int smileIndex) {
        Icon smile = images.iconAt(textCorrIndexes[smileIndex]);
        return new ListItem(smile,
                textCorrWords[smileIndex],
                smile.getWidth(), smile.getHeight());
    }
