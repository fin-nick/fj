...
public class PlainMessage extends Message {
    ...
    public String getProcessedText() {
        ...
        if (isWakeUp()) {
            if (isIncoming()) {
                messageText = PlainMessage.CMD_ME + ResourceBundle.getString("wake_you_up");
            } else {
                messageText = PlainMessage.CMD_ME + ResourceBundle.getString("wake_up");
            }
        }
		return messageText;
	}
    ...
    public Icon getIcon() {
        return msgIcons.iconAt(ICON_MSG_NONE);
    }
}
