 ...
 */
 ...
 class GifDecoder {
	...
	protected Image setPixels(byte[] pixels, int[] activeColorTable) {
        ...
        final int bgThemeColor = 0x00FFFFFF | jimm.ui.Scheme.getSchemeColor(jimm.ui.CanvasEx.THEME_BACKGROUND);
...
//		}
	...
	protected void readImage() {
        ...
        if (bgIndex == transIndex) {
            bgColor = jimm.ui.Scheme.getSchemeColor(jimm.ui.CanvasEx.THEME_BACKGROUND);
        } else {
